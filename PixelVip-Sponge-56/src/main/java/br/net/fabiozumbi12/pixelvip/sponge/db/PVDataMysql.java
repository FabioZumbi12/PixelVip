...
public class PVDataMysql implements PVDataManager {
    ...
    public PVDataMysql(PixelVip plugin) {
        ...
        this.host = plugin.getConfig().root().configs.database.mysql.host;
        this.dbname = plugin.getConfig().root().configs.database.mysql.db_name;
        this.username = plugin.getConfig().root().configs.database.mysql.username;
        this.password = plugin.getConfig().root().configs.database.mysql.password;

        this.keyTable = plugin.getConfig().root().configs.database.mysql.keys.table_name;
        this.colKey = plugin.getConfig().root().configs.database.mysql.keys.columns.key;
        this.colKGroup = plugin.getConfig().root().configs.database.mysql.keys.columns.group;
        this.colKDuration = plugin.getConfig().root().configs.database.mysql.keys.columns.duration;
        this.colKUses = plugin.getConfig().root().configs.database.mysql.keys.columns.uses;
        this.colKInfo = plugin.getConfig().root().configs.database.mysql.keys.columns.info;
        this.colKCmds = plugin.getConfig().root().configs.database.mysql.keys.columns.cmds;
        this.colKComment = plugin.getConfig().root().configs.database.mysql.keys.columns.comments;

        this.vipTable = plugin.getConfig().root().configs.database.mysql.vips.table_name;
        this.colVUUID = plugin.getConfig().root().configs.database.mysql.vips.columns.uuid;
        this.colVVip = plugin.getConfig().root().configs.database.mysql.vips.columns.vip;
        this.colVPGroup = plugin.getConfig().root().configs.database.mysql.vips.columns.playerGroup;
        this.colVDuration = plugin.getConfig().root().configs.database.mysql.vips.columns.duration;
        this.colVNick = plugin.getConfig().root().configs.database.mysql.vips.columns.nick;
        this.colVExpires = plugin.getConfig().root().configs.database.mysql.vips.columns.expires_on_exact;
        this.colVActive = plugin.getConfig().root().configs.database.mysql.vips.columns.active;
        this.colVKits = plugin.getConfig().root().configs.database.mysql.vips.columns.kits;
        this.colVComment = plugin.getConfig().root().configs.database.mysql.vips.columns.comments;

        this.transTable = plugin.getConfig().root().configs.database.mysql.transactions.table_name;
        this.colTPay = plugin.getConfig().root().configs.database.mysql.transactions.columns.payment;
        this.colTID = plugin.getConfig().root().configs.database.mysql.transactions.columns.idt;
        this.colTNick = plugin.getConfig().root().configs.database.mysql.transactions.columns.nick;

        try {
            Class.forName("com.mysql.jdbc.Driver");
        } catch (ClassNotFoundException e2) {
            plugin.getLogger().error("Couldn't find the driver for MySQL: com.mysql.jdbc.Driver.");
            setError();
            return;
        }
    ...
    private void setError() {
        ...
        plugin.getLogger().error("Database set back to file!");
        plugin.reloadCmd();
    }
