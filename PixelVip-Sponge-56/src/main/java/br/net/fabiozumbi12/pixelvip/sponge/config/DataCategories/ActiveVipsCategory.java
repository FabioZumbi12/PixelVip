...
public class ActiveVipsCategory {
    @Setting
    public Map<String, GroupVip> activeVips = new HashMap<>();

    @ConfigSerializable
    public static class GroupVip {
        @Setting
        public Map<String, VipInfo> players = new HashMap<>();

        public GroupVip() {
        }

        public GroupVip(String uuid, VipInfo vip) {
            this.players = new HashMap<String, VipInfo>() {{
                put(uuid, vip);
            }};
        }
