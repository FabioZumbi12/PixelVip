...
public class Metrics {
    ...
    static {
        ...
        if (System.getProperty("bstats.relocatecheck") == null
            ...
            // "trick" ... :D
            final String defaultPackage = new String(new byte[] { 'o', 'r', 'g', '.', 'b', 's', 't',
                    'a', 't', 's', '.', 'b', 'u', 'k', 'k', 'i', 't' });
    ...
    private void startSubmitting() {
        final Timer timer = new Timer(true); // We use a timer cause the Bukkit scheduler is
                                             // affected by server lags
        timer.scheduleAtFixedRate(new TimerTask() {
            ...
            public void run() {
                ...
                // Nevertheless we want our code to run in the Bukkit main thread, so we have to use
    ...
    private JsonObject getServerData() {
        ...
        try {
            ...
            playerAmount = Bukkit.getOnlinePlayers().size(); // Just use the new method if the
                                                             // Reflection failed
        }
                        ...
                        if (plugin instanceof JsonObject) {
                            ...
                            try {
                                ...
                                if (plugin.getClass().isAssignableFrom(jsonObjectJsonSimple)) {
                                    ...
                                    JsonObject object = JsonParser.parseString(jsonString)
                                            .getAsJsonObject();
    ...
    private static void sendData(Plugin plugin, JsonObject data) throws Exception {
        ...
        connection.setRequestProperty("Content-Type", "application/json"); // We send our data in
                                                                           // JSON format
